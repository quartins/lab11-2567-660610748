...
export default function RegisterForm() {
  ...
  const termOnChang = (event: React.ChangeEvent<HTMLInputElement>) => {
    setAllChecks(event.target.checked);
  };
  ...
  return (
    <div className="mx-auto vstack gap-3" style={{ width: "400px" }}>
      ...
      <div>
        <input className="me-2" type="checkbox" onChange={termOnChang} checked={allchecks}/>I agree to the terms and
        conditions
      </div>
